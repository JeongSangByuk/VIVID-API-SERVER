...
public class VideoSpaceApi {
    ...
    public ResponseEntity<SuccessResponse<HostedVideoSpaceGetResponse>> getHostedOneById(
        ...
        return SuccessResponse.success(SuccessCode.OK_SUCCESS, videoSpaceService.getHostedOne(videoSpaceId));
    }
    ...
    public ResponseEntity<SuccessResponse<List<HostedVideoSpaceGetResponse>>> getHostedList() {
        ...
        return SuccessResponse.success(SuccessCode.OK_SUCCESS, videoSpaceService.getHostedList());
    }
