...
public class IndividualVideoApi {
    ...
    public IndividualVideoDetailsGetResponse getDetails(@PathVariable("individual-video-id") String individualVideoId)
            throws IOException {

        IndividualVideoDetailsGetResponse individualVideoDetailsGetResponse = individualVideoService.getDetailsById(
                individualVideoId);
    ...
    public List<IndividualVideoGetResponse> getList(
            @RequestBody @Valid IndividualVideosGetRequest individualVideosGetRequest) {

        List<IndividualVideoGetResponse> individualVideoGetResponse = individualVideoService.findAllByVideoParticipantId(
                individualVideosGetRequest.getVideoSpaceParticipantId());
