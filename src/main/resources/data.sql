delete
from vivid.individual_video;
delete
from vivid.video;
delete
from vivid.video_space_participant;
delete
from vivid.video_space;
delete
from vivid.user;


insert into vivid.user (user_id, created_at, deleted, update_at, email, webex_access_token,
...
insert into vivid.video_space (video_space_id, created_at, deleted, update_at, description,
...
insert into vivid.video (video_id, created_at, deleted, update_at, description, is_uploaded,
...
insert into vivid.video_space_participant (video_space_participant_id, created_at, deleted,
...
insert into vivid.individual_video (individual_video_id, created_at, deleted, update_at,
...
values (0x25EDC4C928A94733B0D53EBB6425B7AD, '2023-03-07 13:15:37.976456', false,
        '2023-03-07 13:15:37.976456', '2023-03-07 13:15:37.970498', 0, 2, 7),
       (0x4D81D45AD4464E70A5508E8019D146EB, '2023-03-07 14:39:34.281074', false,
        '2023-03-07 14:39:34.281074', '2023-03-07 14:39:34.170126', 0, 3, 7),
       (0x6287F6BDC6A6438FBA8B9B5386261472, '2023-03-07 12:53:58.700918', false,
        '2023-03-07 12:53:58.700918', '2023-03-07 12:53:58.695541', 0, 1, 7);