...
//                .andExpect(jsonPath("email").value(TestUserBuilder.MOCK_USER_EMAIL))
//                .andExpect(jsonPath("name").value(TestUserBuilder.MOCK_USER_NAME))
//        ;
//    }
//
//
...
//        UserLoginRequest userLoginRequest = new UserLoginRequest(USER_INVALID_EMAIL, TestUserBuilder.MOCK_USER_NAME);
//
//        //when
//        ResultActions resultActions = mvc.perform(post("/api/account")
//                        .contentType(MediaType.APPLICATION_JSON)
